...
**xTimerCreate\(\)API函数** FreeRTOS V9.0.0还包括xTimerCreateStatic\(\)函数，该函数分配在编译时静态创建计时器所需的内存：软件计时器必须先显式创建，然后才能使用。
...
![&#x56FE;45&#x6267;&#x884C;&#x793A;&#x4F8B;14&#x65F6;&#x4EA7;&#x751F;&#x7684;&#x8F93;&#x51FA;](.gitbook/assets/figure-45.png)
